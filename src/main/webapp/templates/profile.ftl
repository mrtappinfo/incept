      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li class="login">Welcome <span> {{jobseeker}} </span>
            </li>
          </ul>
          </li>
          </ul>
  ...
  <div class="main-content" >
    <div class="container">
      <div class="main-info" >
        ...
        <div class="infoshow"> Average Raise Possible <span>{{averageRaise}}%</span>
        </div>
      ...
      <div class="rangebar" >
        <div class="range-bar">
          <div class="range-slider">
            <div class="spanvalue">
              <h2 class="rangetxt">My Salary <span class="range-slider__value mmg">{{user.salary}</span> K</h2>
            </div>
        ...
        <div class="range-bar range2">
          <div class="range-slider">
            <div class="spanvalue">
              <h2 class="rangetxt">My new raise percentage <span class="range-slider__value mmg">{{user.hike}}</span>%</h2>
            </div>
        ...
        <div class="section-bottom-button text-center">
          <a href="" ng-click="sendrise(recruiters)" class="btn btn-link-1">Submit Again</a>
        </div>	
      </div>
