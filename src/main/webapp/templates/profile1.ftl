      ...
      <div class="rangebar">
        <div class="range-bar">
          <div class="range-slider">
            ...
            <input id = "candidate_salary" ng-model="user.salary" class="range-slider__range" type="range" value="0" min="0" max="280" step="1">
        ...
        <div class="range-bar range2">
          <div class="range-slider">
            ...
            <input id = "candidate_hike" ng-model="user.hike" class="range-slider__range" type="range" value="0" min="0" max="100" step="1">
